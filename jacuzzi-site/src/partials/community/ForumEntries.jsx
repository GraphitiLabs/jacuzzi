                    ...
                    <div className="grow">
                        ...
                        <h2 className="font-semibold text-slate-800 mb-2">
                            <Link to="/community/forum-post">
                                Share Your Startup - December 2021 - Upvote This
            ...
            <article className="bg-white shadow-md rounded border border-slate-200 p-5">
                <div className="flex flex-start space-x-4">
                    ...
                    <div className="grow">
                        ...
                        <h2 className="font-semibold text-slate-800 mb-2">
                            <Link to="/community/forum-post">
                                Failed for the past 12 years as a tech
                                entrepreneur. My key takeaways.
                            </Link>
                        </h2>
                        {/* Footer */}
                        <footer className="flex flex-wrap text-sm">
            ...
            <article className="bg-white shadow-md rounded border border-slate-200 p-5">
                <div className="flex flex-start space-x-4">
                    ...
                    <div className="grow">
                        ...
                        <h2 className="font-semibold text-slate-800 mb-2">
                            <Link to="/community/forum-post">
                                Besides Product Hunt, where else should I
                                promote my new project? 🤔
                            </Link>
                        </h2>
                        {/* Footer */}
                        <footer className="flex flex-wrap text-sm">
            ...
            <article className="bg-white shadow-md rounded border border-slate-200 p-5">
                <div className="flex flex-start space-x-4">
                    ...
                    <div className="grow">
                        ...
                        <h2 className="font-semibold text-slate-800 mb-2">
                            <Link to="/community/forum-post">
                                I built and sold 2 small SaaS products and quit
                                my job in the last two years — AMA.
                            </Link>
                        </h2>
                        {/* Footer */}
                        <footer className="flex flex-wrap text-sm">
            ...
            <article className="bg-white shadow-md rounded border border-slate-200 p-5">
                <div className="flex flex-start space-x-4">
                    ...
                    <div className="grow">
                        ...
                        <h2 className="font-semibold text-slate-800 mb-2">
                            <Link to="/community/forum-post">
                                Had a full-time job, bootstrapped a side project
                                to 7 digit ARR, now building another side
                                project—AMA
                            </Link>
                        </h2>
                        {/* Footer */}
            ...
            <article className="bg-amber-50 shadow-md rounded border border-amber-300 p-5">
                <div className="flex flex-start space-x-4">
                    ...
                    <div className="grow">
                        ...
                        <h2 className="font-semibold text-slate-800 mb-2">
                            <Link to="/community/forum-post">
                                💸 Trade crypto, fiat, and stablecoins with
                                Crypto.io. Low fees and incredible performance!
                            </Link>
                        </h2>
                        {/* Footer */}
                        <footer className="flex flex-wrap text-sm">
            ...
            <article className="bg-white shadow-md rounded border border-slate-200 p-5">
                <div className="flex flex-start space-x-4">
                    ...
                    <div className="grow">
                        ...
                        <h2 className="font-semibold text-slate-800 mb-2">
                            <Link to="/community/forum-post">
                                Which are the main channels you use to drive
            ...
            <article className="bg-white shadow-md rounded border border-slate-200 p-5">
                <div className="flex flex-start space-x-4">
                    ...
                    <div className="grow">
                        ...
                        <h2 className="font-semibold text-slate-800 mb-2">
                            <Link to="/community/forum-post">
                                How to build a following on Twitter as a founder
            ...
            <article className="bg-white shadow-md rounded border border-slate-200 p-5">
                <div className="flex flex-start space-x-4">
                    ...
                    <div className="grow">
                        ...
                        <h2 className="font-semibold text-slate-800 mb-2">
                            <Link to="/community/forum-post">
                                What's the best way to get started building web
                                3 social products?
                            </Link>
                        </h2>
                        {/* Footer */}
            ...
            <article className="bg-white shadow-md rounded border border-slate-200 p-5">
                <div className="flex flex-start space-x-4">
                    ...
                    <div className="grow">
                        ...
                        <h2 className="font-semibold text-slate-800 mb-2">
                            <Link to="/community/forum-post">
                                How important is customer feedback for the
