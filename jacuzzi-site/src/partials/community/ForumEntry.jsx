    ...
    return (
        <article className="bg-white shadow-md rounded border border-slate-200 p-5">
            ...
            <div className="space-y-4 mb-6">
                <p>
                    Looking for new ideas to get users, receive feedback, and
                    increase exposure! Besides PH, where else do you showcase
                    your product?
                </p>
                <p>Please advise 🙌</p>
            </div>
                        ...
                        <div className="flex items-start">
                            ...
                            <div>
                                ...
                                <div className="grow text-sm text-slate-800 space-y-2 mb-2">
                                    <p>
                                        We've also had the same question to be
                                        honest. And for Appy.com launch we
                                        decided to go with Twitter as a primary
                                        medium and then Product Hunt as the
                                        other one. And I have to say that it led
                                        to some great results as Twitter allows
                                        you to be super active and engage in
                                        many conversations.
                                    </p>
                                    <p>
                                        Also, users are there and everything is
                                        super active. So that will be my advice
                    ...
                    <li className="relative pl-9 space-y-5">
                        ...
                        <div className="flex items-start">
                            ...
                            <div>
                                ...
                                <div className="grow text-sm text-slate-800 space-y-2 mb-2">
                                    <p>
                                        If you are a SaaS product and are
                                        looking for early adopters, AppSumo
                                        seems to be a great place to list on.
                                        Most of the users there seem to be
                                        early-adopters. Life-time deals seem to
                                        be the norm there.
                                    </p>
                                </div>
                                {/* Comment footer */}
                            ...
                            <div>
                                ...
                                <div className="grow text-sm text-slate-800 space-y-2 mb-2">
                                    <p>
                                        ...
                                        who are posting other alt=""ernatives! I
                                        will launch my free product design
                                        course in February and I will make a
                                        notion template with all this
                                        information! :)
                                    </p>
                                </div>
                                {/* Comment footer */}
                    ...
                    <li className="relative pl-9 space-y-5">
                        ...
                        <div className="flex items-start">
                            ...
                            <div>
                                ...
                                <div className="grow text-sm text-slate-800 space-y-2 mb-2">
                                    <p>
                                        Social Media (channels based on your
                                        target audience), and Slack channels
                                    </p>
                                </div>
                                {/* Comment footer */}
                                <div className="flex flex-wrap text-xs">
