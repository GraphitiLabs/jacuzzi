        ...
        <>
            ...
            <div className="bg-white shadow-md rounded border border-slate-200 p-5">
                ...
                <div className="text-sm text-slate-800 space-y-2 mb-5">
                    <p>👋</p>
                    <p>
                        It's more likely that people reading your blog will opt
                        in with their email addresses if you give them something
                        highly relevant in return. Ditch that too-general lead
                        magnet and create "content upgrades" for your
                            ...
                            <div className="flex items-start space-x-3">
                                ...
                                <div>
                                    ...
                                    <div className="text-sm">
                                        ...
                                        Reading through and really enjoying
                                        "Zero to Sold" by Arvid.
                                    </div>
                                </div>
                            </div>
                        </li>
                        ...
                        <li className="p-3 bg-slate-50 rounded">
                            <div className="flex items-start space-x-3">
                                ...
                                <div>
                                    ...
                                    <div className="text-sm">
                                        Depends on the company you're running,
                                        but if I had to choose just one book,
                                        it'd be The Personal MBA by Josh
                                        Kaufman.
                                    </div>
                                </div>
                            </div>
            ...
            <div className="bg-white shadow-md rounded border border-slate-200 p-5">
                ...
                <div className="text-sm text-slate-800 space-y-2 mb-5">
                    <p>
                        Kyla Network - Make new connections, join communities,
