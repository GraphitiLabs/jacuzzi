    ...
    return (
        <div className="grow px-4 sm:px-6 md:px-5 py-6">
            ...
            <div className="flex items-start mb-4 last:mb-0">
                ...
                <div>
                    <div className="text-sm bg-white text-slate-800 p-3 rounded-lg rounded-tl-none border border-slate-200 shadow-md mb-1">
                        Can anyone help? I have a question about Acme
                        Professional
                    </div>
            ...
            <div className="flex items-start mb-4 last:mb-0">
                ...
                <div>
                    <div className="text-sm bg-white text-slate-800 p-3 rounded-lg rounded-tl-none border border-slate-200 shadow-md mb-1">
                        What do you think? Duis aute irure dolor in
                        reprehenderit 🔥
                    </div>
                    <div className="flex items-center justify-between">
                        <div className="text-xs text-slate-500 font-medium">
            ...
            <div className="flex items-start mb-4 last:mb-0">
                ...
                <div>
                    <div className="text-sm bg-indigo-500 text-white p-3 rounded-lg rounded-tl-none border border-transparent shadow-md mb-1">
                        Sed euismod nisi porta lorem mollis. Tellus elementum
                        sagittis vitae et leo duis. Viverra justo nec ultrices
                        dui.
                        <br />
                        Sed lectus vestibulum mattis ullamcorper velit sed. Ut
